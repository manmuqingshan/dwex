...
def setup_menu(win):
    ...
    win.abbrevs_menuitem = view_menu.addAction("Abbrev table...")
    win.abbrevs_menuitem.setEnabled(False)
    win.abbrevs_menuitem.triggered.connect(win.on_abbrevs)
    view_menu.addSeparator()
    ...
    win.datasec_menuitem = ana_menu.addAction("Data section...")
    win.datasec_menuitem.setEnabled(False)
    win.datasec_menuitem.triggered.connect(win.on_datasec)    
